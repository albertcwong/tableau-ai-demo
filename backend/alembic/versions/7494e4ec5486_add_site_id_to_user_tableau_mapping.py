"""add_site_id_to_user_tableau_mapping

Revision ID: 7494e4ec5486
Revises: m_user_tableau_mapping
Create Date: 2026-02-07 09:12:31.331583
...
revision: str = '7494e4ec5486'
down_revision: Union[str, Sequence[str], None] = 'm_user_tableau_mapping'
...
def downgrade() -> None:
    ...
    if column_exists:
        ...
        # Recreate old unique constraint without site_id
        conn.execute(text("""
            CREATE UNIQUE INDEX idx_user_tableau_mapping_unique 
